...
export default function WhyUs() {
  ...
  return (
    <section ref={containerRef} className="relative py-24 overflow-hidden">
      ...
      <motion.div
        style={{ y }}
        className="absolute -right-20 top-1/4 h-96 w-96 rounded-full bg-brutal-cyan/5 blur-3xl"
      />
      <motion.div
        style={{ y: useTransform(scrollYProgress, [0, 1], [-60, 60]) }}
        className="absolute -left-20 bottom-1/4 h-72 w-72 rounded-full bg-brutal-pink/5 blur-3xl"
      />
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-3xl font-extrabold uppercase tracking-tight sm:text-4xl md:text-display-md">
              ...
              <span className="text-brutal-pink text-glow-pink">CONSULTING FIRM</span>
            </h2>
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={item} className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 shrink-0 text-brutal-cyan mt-0.5" />
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {reasons.map((reason, i) => {
              ...
              return (
                ...
                >
                  <Icon className="h-8 w-8 text-brutal-cyan mb-4" />
