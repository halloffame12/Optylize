...
const footerLinks = {
  services: [
    ...
    { label: 'Data Readiness', href: '/services' },
        ...
        <div className="grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 space-y-3">
              <a href="mailto:hello@optylize.com" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-brutal-cyan transition-colors">
          ...
          {/* Services */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-brutal-cyan">Services</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-brutal-cyan">Company</h4>
            <ul className="space-y-3">
          ...
          {/* Resources */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-brutal-cyan">Resources</h4>
            <ul className="space-y-3">
