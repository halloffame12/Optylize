        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {articles.map((article, i) => (
            ...
            >
              ...
              <div className={`relative ${article.featured ? 'h-48' : 'h-32'} bg-gradient-to-br from-black/10 via-card to-black/5`}>
              ...
              <div className="p-6">
                <h3 className={`font-bold text-foreground mb-3 group-hover:text-black transition-colors ${article.featured ? 'text-xl' : 'text-base'
                  }`}>
                  {article.title}
                </h3>
