                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        <AnimatePresence mode="popLayout">
                            {filtered.map((article, i) => (
                                ...
                                >
                                    <div className="h-40 bg-gradient-to-br from-black/10 via-card to-black/5 relative">
                                    ...
                                    <div className="p-6">
                                        <h3 className="text-lg font-bold text-white mb-3 group-hover:text-white/80 transition-colors line-clamp-2">
                                            {article.title}
                                        </h3>
