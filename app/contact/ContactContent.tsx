    ...
    return (
        <main>
            ...
            <section className="relative pt-32 pb-20">
                <div className="absolute inset-0 bg-gradient-to-br from-brutal-cyan/5 via-background to-brutal-yellow/5" />
                    ...
                    <div className="grid gap-12 lg:grid-cols-5">
                        ...
                        >
                                ...
                                {contactInfo.map((item) => {
                                    ...
                                    const content = (
                                        <div className="flex items-start gap-4 group">
                                            <div className="flex h-12 w-12 shrink-0 items-center justify-center border-[3px] border-brutal-cyan bg-brutal-cyan/10">
                                                <Icon className="h-5 w-5 text-brutal-cyan" />
                                            </div>
                                            <div>
                                                <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground">{item.label}</p>
                                                <p className="text-foreground font-medium mt-1 group-hover:text-brutal-cyan transition-colors">{item.value}</p>
                                            </div>
                                        </div>
                                    )
                                    return item.href ? (
                            ...
                            <div className="mt-10 aspect-video rounded-xl skeu-card overflow-hidden">
                                <div className="h-full w-full bg-gradient-to-br from-brutal-cyan/5 via-card to-brutal-pink/5 flex items-center justify-center">
                                    <div className="text-center">
                                        <MapPin className="h-10 w-10 text-brutal-cyan mx-auto mb-3" />
                                        <p className="text-sm font-bold uppercase tracking-wider text-muted-foreground">SAN FRANCISCO, CA</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea
                                            ...
                                            rows={5}
                                            className={`skeu-input resize-none ${errors.message ? 'border-red-500' : ''}`}
                                            {...register('message')}
                                        />
            ...
            <section className="relative py-16 bg-card/50 border-t border-border">
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
                    <Clock className="h-10 w-10 text-brutal-cyan mx-auto mb-4" />
