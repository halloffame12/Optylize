...
const team = [
  { name: 'Alex Rivera', role: 'Co-Founder & CEO', initials: 'AR', color: 'bg-clay-pink' },
  { name: 'Priya Sharma', role: 'Co-Founder & CTO', initials: 'PS', color: 'bg-clay-blue' },
  { name: 'James Chen', role: 'Head of AI Engineering', initials: 'JC', color: 'bg-clay-green' },
  { name: 'Maria Santos', role: 'VP of Strategy', initials: 'MS', color: 'bg-clay-purple' },
  { name: 'David Kim', role: 'Lead ML Engineer', initials: 'DK', color: 'bg-clay-pink' },
  { name: 'Sarah O\'Brien', role: 'Head of Delivery', initials: 'SO', color: 'bg-clay-blue' },
]
  ...
  return (
    <main>
      ...
      <section ref={teamRef} className="relative py-20">
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <p className="mb-3 text-xs font-bold uppercase tracking-[0.25em] text-clay-pink">
              OUR TEAM
            </p>
            <h2 className="text-3xl font-extrabold uppercase tracking-tight">
              <span className="text-foreground">THE </span>
              <span className="text-clay-pink">HUMANS </span>
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl font-extrabold uppercase tracking-tight">
              ...
              <span className="text-brutal-cyan">TIMELINE</span>
            </h2>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {milestones.map((m, i) => (
              ...
              >
                <span className="text-3xl font-extrabold text-brutal-cyan">{m.year}</span>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl font-extrabold uppercase tracking-tight">
              ...
              <span className="text-brutal-pink">STAND FOR</span>
            </h2>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {values.map((v, i) => {
              ...
              return (
                ...
                >
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center bg-brutal-pink border-[3px] border-black">
      ...
      {/* CTA */}
      <section className="relative py-20 bg-brutal-pink">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8">
            <Link href="/contact">
              <Button size="xl" className="brutal-btn bg-black text-brutal-pink border-black shadow-[4px_4px_0px_0px_#FFE600] gap-2 text-base">
