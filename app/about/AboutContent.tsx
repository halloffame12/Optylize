                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <h1 className="text-4xl font-extrabold uppercase tracking-tight sm:text-5xl md:text-display-xl">
                            ...
                            <span className="text-black/60">PRACTITIONERS</span>
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {team.map((member, i) => (
                            ...
                            >
                                <div className={`mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full ${member.color} text-2xl font-bold text-white`}>
                                    {member.initials}
                                </div>
