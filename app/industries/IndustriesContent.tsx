...
const industries = [
    {
        ...
        color: 'border-brutal-cyan/40',
        iconColor: 'text-brutal-cyan',
    },
    {
        icon: HeartPulse,
        name: 'Healthcare',
        ...
        color: 'border-brutal-pink/40',
        iconColor: 'text-brutal-pink',
    },
    {
        icon: ShoppingCart,
        ...
        color: 'border-brutal-yellow/40',
        iconColor: 'text-brutal-yellow',
    },
    {
        icon: Factory,
        name: 'Manufacturing',
        ...
        <main>
            ...
            <section className="relative pt-32 pb-20">
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <p className="mb-4 text-xs font-bold uppercase tracking-[0.25em] text-brutal-yellow">
                            INDUSTRY VERTICALS
                        </p>
                        <h1 className="text-4xl font-extrabold uppercase tracking-tight sm:text-5xl md:text-display-xl">
                            ...
                            <span className="text-brutal-yellow">EVERY </span>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-8">
                        {['SOC 2', 'HIPAA', 'GDPR', 'PCI DSS', 'ISO 27001'].map((badge) => (
                            <div
                                key={badge}
                                className="brutal-card bg-card px-6 py-3 text-xs font-bold uppercase tracking-wider text-brutal-cyan"
                            >
